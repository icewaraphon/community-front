...
export class RegisterComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.registerService.getAllAmphur().subscribe(res => { this.amphurs = res; });
    this.registerService.getAllProvince().subscribe(res => { this.provinces = res; })
  ...
  onSubmit() {
    ...
    if (this.customersRegisterForm.invalid) {
      ...
      this.registerService.saveCustomers(this.customersRegisterForm.value).subscribe(res => {
  ...
  get customersf() { return this.customersRegisterForm.controls; }
